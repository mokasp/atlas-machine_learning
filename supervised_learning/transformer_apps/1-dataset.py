...
class Dataset():
    """ a class used to load, preprocess, and tokenize a dataset for machine
        ...
        Methods:
            __init__(self):
                Initializes the Dataset class by loading the dataset and
                creating tokenizers for both Portuguese and English languages.
            ...
            encode(self, pt, en):
                Encodes Portuguese and English sentences into sequences of
                subword tokens, adding start and end tokens.
    """
    ...
    def encode(self, pt, en):
        """ encodes Portuguese and English sentences into sequences
            of subword tokens, adding start and end tokens.

            Args:
                pt (tf.Tensor): A TensorFlow tensor containing a Portuguese
                                sentence.
                en (tf.Tensor): A TensorFlow tensor containing an English
                                sentence.

            Returns:
                tuple: A tuple containing two lists of tokens. The first list
                       represents the Portuguese sentence and the second list
