...
def autoencoder(input_dims, hidden_layers, latent_dims):
    ...
    first_hidden = K.layers.Dense(units=hidden_layers[1], activation='relu')(inpt)
    second_hidden = K.layers.Dense(units=hidden_layers[0], activation='relu')(first_hidden)
    latent = K.layers.Dense(units=input_dims, activation='sigmoid')(second_hidden)
