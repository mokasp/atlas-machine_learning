#!/usr/bin/env python3
""" script that allows the trained reinforcement learning agent to play an
    episode of Atari's Breakout and displays the game play.
...
# use greedy policy, always choosing exploitation and choosing the action
