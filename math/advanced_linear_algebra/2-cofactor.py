#!/usr/bin/env python3
""" module containing function that calculates the cofactor matrix of a
    given square matrix."""
...
def cofactor(matrix):
    """
    function that calculates the cofactor matrix of a given square matrix.

    Args:
        matrix (list of lists): A square matrix whose cofactor matrix is to
                                be calculated.
