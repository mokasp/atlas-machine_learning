...
"""
    ...
    Args:
        ...
        size (list or tuple): A list or tuple specifying the target size of
        the cropped image, in the format [height, width, channels].
...
def crop_image(image, size):
    """ This function uses TensorFlow's `random_crop` method to randomly crop
        the input image to the given size.
        The size should be specified as a list or tuple of the form
