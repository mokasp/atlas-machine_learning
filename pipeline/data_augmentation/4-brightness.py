...
"""
    ...
    This function uses TensorFlow's `random_brightness` method to randomly adjust 
    the brightness of the input image by a value within the range [-max_delta, max_delta].
